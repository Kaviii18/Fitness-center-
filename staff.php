...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content">
            ...
            <a href="add_staff.php" class="btn btn-add">Add New Staff</a>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td>
                                    ...
                                    <a href='delete_staff.php?id={$row['id']}' class='btn btn-delete' onclick='return confirm(\"Are you sure you want to delete this staff member?\");'>Delete</a>
                                </td>
                            </tr>";
                        }
                    } else {
